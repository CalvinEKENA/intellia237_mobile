...
abstract class AppLocalizations {
  ...
  ///
  /// In fr, this message translates to:
  /// **'Connecte-toi pour faire valider tes points de parcours.'**
  ...
  ///
  /// In fr, this message translates to:
  /// **'La validation des points de parcours est réservée aux profils élèves.'**
  ...
  ///
  /// In fr, this message translates to:
  /// **'La réponse au parcours envoyée est invalide.'**

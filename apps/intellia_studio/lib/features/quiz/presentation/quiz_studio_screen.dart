...
final questionsProvider =
    StateNotifierProvider<QuestionsNotifier, List<StudioQuizQuestion>>((ref) {
  ...
  QuestionsNotifier()
    : super([
        const StudioQuizQuestion(
          ...
          correctIndex: 0,
          explanation:
              'Par formule de dérivation des composées : (ln(u))\' = u\' / u avec u(x) = 3x^2 + 1 et u\'(x) = 6x.',
        ...
        const StudioQuizQuestion(
          ...
          classLevel: 'Terminale',
          prompt:
              'Si lim f(x) = +infini quand x tend vers a, alors la droite d\'équation x = a est :',
          options: [
          ...
          correctIndex: 1,
          explanation:
              'Une limite infinie en un point fini définit une asymptote verticale x = a.',
        ...
        const StudioQuizQuestion(
          ...
          classLevel: 'Terminale',
          prompt:
              'Dans le Système International, quelle est l\'unité de la constante de raideur k d\'un ressort ?',
          options: ['N.m', 'N / m', 'J / m^2', 'kg.s^-1'],
          correctIndex: 1,
          explanation:
              'D\'après la loi de Hooke F = k * x, k = F / x donc l\'unité est le Newton par mètre (N/m).',
          difficulty: QuizDifficulty.intermediaire,
        ),
      ]);
...
class _QuizStudioScreenState extends ConsumerState<QuizStudioScreen> {
  ...
  Widget build(BuildContext context) {
        ...
        : (academicContext.selectedClass == null
              ...
              : allQuestions.where((q) {
                  ...
                  final targetId = academicContext.selectedClass!.id
                      .toLowerCase();
                  final matchClass =
                      q.classLevel.toLowerCase() == targetKey ||
    ...
    final currentPreview =
        previewQuestion ?? (questions.isNotEmpty ? questions.first : null);
                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: currentPreview == null
                          ? const Center(
                              child: Text(
                                'Sélectionnez une question pour la tester.',
                              ),
                            )
                          : Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                for (
                                  int i = 0;
                                  i < currentPreview.options.length;
                                  i++
                                ) ...[
                                  ListTile(
                                    shape: RoundedRectangleBorder(
              ...
              onPressed: () {
                ...
                if (academicCtx.selectedClass == null) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                        'Veuillez d\'abord sélectionner une classe dans la barre académique.',
                      ),

...
final audienceRulesProvider =
    StateNotifierProvider<AudienceRulesNotifier, List<StudioAudienceRule>>((
      ref,
    ) {
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            onChanged: (val) => setState(
                              () => testClassLevel = val ?? testClassLevel,
                            ),
                          ),
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            onChanged: (val) =>
                                setState(() => testSeries = val ?? testSeries),
                          ),
                          const SizedBox(height: 12),
                          SwitchListTile(
                              ...
                              children: [
                                for (final r in rules)
                                  if (r.matches(
                                    ...
                                    Card(
                                      elevation: 0,
                                      color: StudioColors.success.withValues(
                                        alpha: 0.08,
                                      ),
                                      shape: RoundedRectangleBorder(

...
void main() {
  group('Phase C — Content Models & Dual-Write Serialization', () {
    test('StudioLesson generates both contentBlocks (V2) and contentSections (V1)', () {
  ...
  group('Phase C — FLOW Publication Server-Parity Contract', () {
    ...
    test('Validates Quiz payload: requires >= 2 options and valid correctIndex', () {
  ...
  group('Phase C — Quiz & Audience Targeting Rules', () {
    ...
    test('StudioAudienceRule correctly segments students by class, series and tier', () {
